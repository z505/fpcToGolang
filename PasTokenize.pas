...
********************************************************************************
 ...
 in this parser comes from those people. Portions copyright Julian Bucknall
 and Thaddy de Koning - this code has been modified quite a bit from their
 original works.
...
{$i PasParserDef.inc}
 ...
 { public methods }
  procedure GetToken(var ATokType: TPasToken; var ATok: string;
  ParserSelf: PPasParser; self: PChrStrm);

procedure Getatok(aInStm: PChrStrm; var aTokType: TPasToken; var aTok: string;
  self: PChrStrm);
...
procedure ReadNumber(aInStm : PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
...
procedure ReadHexNumber(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
...
procedure ReadIdentifier(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
begin
  ch:=aInStm^.GetChar(self);
...
procedure ReadString(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
begin
  ch:=aInStm^.GetChar(self);
...
procedure ReadBraceComment(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
begin
  ch:=aInStm^.GetChar(self);
...
procedure ReadSlashComment(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch : char;
begin
  ch:= aInStm^.GetChar(self);
...
procedure ReadWhitespace(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch: char;
begin
  aTok:= '';
...
procedure ReadParenComment(aInStm: PChrStrm; var aTok: string; self: PChrStrm);
var
  Ch: char;
